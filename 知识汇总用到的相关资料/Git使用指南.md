...
**方法2：**
选中要看的文件，点击时间线，则会显示每一次提交所做的修改。左修改前/右修改后，简单直观！！！
![22](D:\Data\项目&比赛&自学\0. 知识汇总\知识汇总用到的相关资料\Git学习指南\图片\22.png)
...
此时 远程仓库与本地仓库创建关联，点击 发布 Branch；
之后点击 同步更改，即可完成 远程仓库上传（执行`git push`操作）；
